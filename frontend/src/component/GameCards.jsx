...
const GameCards = () => {
  ...
  const games = [
    { title: "Pixel Racer", color: "#4facfe" },
    { title: "Dungeon Escape", color: "#ff7043" },
    { title: "Galaxy Shooter", color: "#ba68c8" },
  ];
        ...
        <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
          {games.map((game, index) => (
            ...
            >
              ...
              <button
                className="mt-2 px-6 py-3 rounded-full font-bold transition-all duration-300 hover:scale-105 hover:shadow-lg"
                style={{
                  background: `linear-gradient(to right, ${
                    game.color
                  }, ${adjustColor(game.color, 20)})`,
                  color: getContrastColor(game.color),
                  boxShadow: `0 4px 15px ${adjustColor(game.color, -20, 0.5)}`,
                }}
              >
                Play Now →
              </button>
